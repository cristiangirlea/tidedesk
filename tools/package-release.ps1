...
$notes = @(
    ...
    $signingText,
    '',
    'This build uses protocol v2 and is compatible with v0.1.0-alpha.1. If upgrading from the original v0.1.0-alpha (v1), update both host and viewer together.',
    '',
    'New: the viewer remembers each host window location and monitor. Sessions start at the host native pixel size, shrinking proportionally only when needed to fit the available screen. Neither display resolution is changed.',
    '',
    ...
    '',
    '[Clipboard and mouse controls](https://github.com/cristiangirlea/tidedesk/blob/main/docs/interaction-controls.md)',
    '',
