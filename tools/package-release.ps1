...
$notes = @(
    ...
    $signingText,
    '',
    'Update both host and viewer together. This build uses protocol v2 and cannot connect to the original v0.1.0-alpha (v1).',
    '',
    ...
    '',
    'Alpha validation: automated checks pass; live two-computer verification of the new interaction controls is still pending.',
    '',
